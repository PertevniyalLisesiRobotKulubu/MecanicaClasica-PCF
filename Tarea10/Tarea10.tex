...
\eqref{eq:2qdot1} y \eqref{eq:2pdot1}, y el hecho de que\footnote{Tomaremos los casos 
para los que $p>0$.}
...
\begin{split}
 ...
 \underset{\circled{1}}{\frac{\partial f}{\partial q^i}
  ...
  \frac{\partial^2 f}{\partial^2(q^i)^2}} \\
  + \underset{\circled{11}}{\frac{\partial h}{\partial q^i}
  \frac{\partial^2 f}{\partial p_i\partial q^i}\frac{\partial g}{\partial p_i}}
  + \underset{\circled{3}}{\frac{\partial h}{\partial q^i}
  \frac{\partial f}{\partial q^i}\frac{\partial^2 g}{\partial p_i^2}}
  -\underset{\circled{9}}{\frac{\partial h}{\partial q^i}
  \frac{\partial^2 f}{\partial p_i^2}\frac{\partial g}{\partial q^i}} 
  -\underset{\circled{7}}{\frac{\partial h}{\partial q^i} 
  \frac{\partial f}{\partial p_i}\frac{\partial^2 g}{\partial p_i \partial q^i}} \\
  - \underset{\circled{12}}{\frac{\partial h}{\partial p_i}\frac{\partial^2 f}{\partial (q^i)^2}
  \frac{\partial g}{\partial p_i}} - \underset{\circled{1}}{\frac{\partial h}{\partial p_i}\frac{\partial f}{\partial q^i}
  \frac{\partial^2 g}{\partial q^i\partial p^i}} + \underset{\circled{10}}{\frac{\partial h}{\partial p_i}\frac{\partial^2 f}{\partial q^i\partial p_i}
  \frac{\partial g}{\partial q^i}} + \underset{\circled{5}}{\frac{\partial h}{\partial p_i}\frac{\partial f}{\partial p_i}
  \frac{\partial^2 g}{\partial^2(q^i)^2}}.
\end{split}
\end{align}

Vemos entonces que podemos escribir, para hacer mucho más fácil la cancelación
de términos

\begin{align*}
 \{f,\{g,h\}\} + \{g,\{h,f\}\} + \{h,\{f,g\}\} = \circled{1} + \circled{2} 
 - \circled{3} - \circled{4} - \circled{5} - \circled{6} + \circled{7} \\
 + \circled{8} + \circled{6} + \circled{9} - \circled{2} - \circled{10}
 - \circled{8} - \circled{11} + \circled{4} + \circled{12} + \circled{11} \\
 + \circled{3} - \circled{9} - \circled{7} - \circled{12} - \circled{1} 
 + \circled{10} + \circled{5},
\end{align*}

ordenando tenemos

\begin{align*}
 \{f,\{g,h\}\} + \{g,\{h,f\}\} + \{h,\{f,g\}\} = \circled{1} - \circled{1} 
 + \circled{2} - \circled{2} + \circled{3} - \circled{3} \\
 + \circled{4} - \circled{4} + \circled{5} - \circled{5} + \circled{6} - \circled{6} \\
 + \circled{7} - \circled{7} + \circled{8} - \circled{8} + \circled{9} - \circled{9} \\
 + \circled{10} - \circled{10} + \circled{11} - \circled{11} + \circled{12} - \circled{12}.
\end{align*}
