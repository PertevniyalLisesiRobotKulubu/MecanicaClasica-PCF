...
añadiendo un contra peso del cardán interno de un giroscopio, que resulta en un 
...
\begin{figure}[H]
\center 
\includegraphics[scale=0.4]{apendice2fig1}
...
es el espín, ${^F}{ \vec{\omega}}^{B} = \dot{\phi}\hat{f}_3$.
