...
lo cual lo haremos utilizando un nuevo sistema de coordenadas $R^i = r^i\sqrt{T_i}$, 
donde las $T_i$ son los eigenvalores de $T$, el cual utilizaremos para reescalar 
la matriz $V_{ij}$ y luego diagonzalizarla para obtener sus eigenvalores que nos 
permitirán encontrar las frecuencias normales, y luego los modos normales. Por último 
un comentario sobre notación: denotaremos por $\phi_i$ el desplazamiento de cada 
