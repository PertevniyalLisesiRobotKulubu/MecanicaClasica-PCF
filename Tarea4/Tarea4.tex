...
\begin{figure}[H]
\center
\includegraphics[scale=0.45]{problema2fig2}
\caption{$y_1$ vs $x_1$}
...
\begin{figure}[H]
\center
\includegraphics[scale=0.45]{problema2fig3}
\caption{$y_2$ vs $x_1$}
...
\begin{figure}[H]
\center
\includegraphics[scale=0.45]{problema2fig4}
\caption{$y_1$ vs $x_2$}
...
\begin{figure}[H]
\center
\includegraphics[scale=0.45]{problema2fig5}
\caption{$y_2$ vs $x_2$}
...
\begin{figure}[H]
\center
\includegraphics[scale=0.45]{problema2fig6}
