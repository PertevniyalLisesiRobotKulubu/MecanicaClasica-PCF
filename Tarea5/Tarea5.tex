...
$L_1$, $L_2$ y $\phi$ son lineales en $\dot{q}^i$, por lo que
...
\begin{equation}
 \frac{\partial \phi}{\partial q^i} = \frac{\Xi_i}{\partial q^i}\dot{q}^i + \frac{\Gamma}{\partial q^i}
\end{equation}
...
y sustituyendo \mref{eq:4xi1} en \mref{eq:4cero1} tenemos que
