...
% 
% \begin{equation}
%  m_1\mathbf{r_1} + m_2\mathbf{r_2} = (m_1 + m_2)\mathbf{R}
% \end{equation}
...
una expresión para $\dot{X}$ de \mref{eq:pendu8},
...
% 
% \begin{align*}
%  E &= \frac{M+m}{2}\left(\frac{p_x - l\dot{\theta}\cos{\theta}}{M+m}\right)^2 + 
%  \frac{ml^2 \dot{\theta}^2}{2} + ml\dot{\theta}\cos{\theta}\left(\frac{p_x - l\dot{\theta}\cos{\theta}}{M+m}\right)
%  - mgl\cos{\theta}, \\
%  %
%    &= \frac{M+m}{2}\left[ \frac{p_x^2 - 2 p_x l \dot{\theta}\cos{\theta}+ l^2 \dot{\theta}^2 \cos^2{\theta}}{(M+m)^2} \right]
%    + \frac{ml^2 \dot{\theta}^2}{2} + \frac{p_xml\dot{\theta}\cos{\theta - ml^2\dot{\theta}^2\cos{\theta}}}{M+m} \\
%    &- mgl\cos{\theta}, \\
%  % 
%  &= \frac{p_x^2 - 2 p_x l \dot{\theta}\cos{\theta}+ l^2 \dot{\theta}^2 \cos^2{\theta}}{2(M+m)}
%  + \frac{ml^2 \dot{\theta}^2}{2} + \frac{p_xml\dot{\theta}\cos{\theta - ml^2\dot{\theta}^2\cos{\theta}}}{M+m}
%    - mgl\cos{\theta},
%  %
% \end{align*}
