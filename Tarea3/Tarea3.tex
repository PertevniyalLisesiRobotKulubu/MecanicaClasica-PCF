...
Entonces en este caso, tomando a $l$ como constante, tendremos el gráfico \mref{fig:rDotR}. Las 
...
el punto de cruce externo se va a $r=\inf$. Esta es la separatriz para este problema, y 
corresponde a una órbita parabólica en el espacio de configuración (ver figura \mref{fig:parabola}).
...
o a una órbita circular en el espacio de configuración (ver figura \mref{fig:circulo}),
...
y este límite inferior corresponden a elipses en el espacio de configuración (ver 
...
órbitas en el espacio de configuración para $E>0$ correspondan a órbitas hiperbólicas 
